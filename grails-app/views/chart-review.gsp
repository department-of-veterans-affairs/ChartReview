...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="js/packages/chart-review-theme/build/resources/chart-review-theme-all-debug.css" />
    ...
    <script type="text/javascript">
        Ext.Loader.setPath('CR.app', 'js/chart-review/app');
        Ext.Loader.setPath('CR.app.model', 'js/chart-review/app/model');
        Ext.Loader.setPath('CR.app.view', 'js/chart-review/app/view');
        Ext.Loader.setPath('CR.app.controller', 'js/chart-review/app/controller');
        Ext.Loader.setPath('CR.app.model', 'js/chart-review/app/model');
        Ext.Loader.setPath('CR.app.store', 'js/chart-review/app/store');
        Ext.Loader.setPath('CR.app.view', 'js/chart-review/app/view');
        Ext.Loader.setPath('CR.ux', 'js/chart-review/app/ux');
        Ext.Loader.setPath('Ext.ux', 'js/ext/src/ux');
    </script>
    <script type="text/javascript" src="js/chart-review/app.js"></script>
    <!-- </x-compile> -->
...
<div style="margin-top: 46px">
    <div id="appContent" style="padding: 0px; margin: 0px; width: 100%; height: 100%; overflow: hidden"></div>
</div>
</body>
</html>
