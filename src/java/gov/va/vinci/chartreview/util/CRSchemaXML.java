...
/*
 * COPIED BY RBA for CR schema marshalling so isRendering never gets set to false...wish they would have made the field or checkState method protected..
 * PORTING TO A LATER VERSION OF THIS - SIMPLY MAKE ALL OF THE ISRENDERING ASSIGNMENTS SET THE VARIABLE TO TRUE.  NO OTHER CHANGES
 *
 ...
 */
public class CRSchemaXML extends AbstractConverter<XMLStreamWriter> implements IncludeExcludeConverter<XMLStreamWriter> {
    public static final Log log = LogFactory.getLog(CRSchemaXML.class);
    ...
    private final ConverterConfiguration<CRSchemaXML> config;
    ...
    public CRSchemaXML() {
        config = ConvertersConfigurationHolder.getConverterConfiguration(CRSchemaXML.class);
    ...
    public CRSchemaXML(Object target) {
        this();
        this.target = target;
    }

    public CRSchemaXML(XMLStreamWriter writer) {
        this();
        this.writer = writer;
    ...
    protected ConverterConfiguration<CRSchemaXML> initConfig() {
        return ConvertersConfigurationHolder.getConverterConfiguration(CRSchemaXML.class);
    }
    ...
    public String getElementName(Object o) {
        ObjectMarshaller<CRSchemaXML> om = config.getMarshaller(o);
        ...
        try {
            if (o == null) {
                ...
                if (referenceStack.contains(o)) {
                    ...
                    ObjectMarshaller<CRSchemaXML> marshaller = config.getMarshaller(o);
                    if (marshaller == null) {
    ...
    public ObjectMarshaller<CRSchemaXML> lookupObjectMarshaller(Object target) {
    ...
    public CRSchemaXML startNode(String tagName) {
        checkState();
        try {
    ...
    public CRSchemaXML chars(String chars) {
        checkState();
        try {
    ...
    public CRSchemaXML attribute(String name, String value) {
        checkState();
        try {
...
//        }
    ...
    /**
     * Parses the given CRSchemaXML
     *
     * @param source a String containing some CRSchemaXML
    ...
    public static ConverterConfiguration<CRSchemaXML> getNamedConfig(String configName) throws ConverterException {
        ConverterConfiguration<CRSchemaXML> cfg = ConvertersConfigurationHolder.getNamedConverterConfiguration(
                configName, CRSchemaXML.class);
        if (cfg == null) {
    ...
    public static Object use(String configName, Closure<?> callable) throws ConverterException {
        ConverterConfiguration<CRSchemaXML> old = ConvertersConfigurationHolder.getThreadLocalConverterConfiguration(CRSchemaXML.class);
        ConverterConfiguration<CRSchemaXML> cfg = getNamedConfig(configName);
        ConvertersConfigurationHolder.setTheadLocalConverterConfiguration(CRSchemaXML.class, cfg);
        try {
            return callable.call();
        }
        finally {
            ConvertersConfigurationHolder.setTheadLocalConverterConfiguration(CRSchemaXML.class, old);
        }
    }

    public static void use(String cfgName) throws ConverterException {
        if (cfgName == null || "default".equals(cfgName)) {
            ConvertersConfigurationHolder.setTheadLocalConverterConfiguration(CRSchemaXML.class, null);
        }
        else {
            ConvertersConfigurationHolder.setTheadLocalConverterConfiguration(CRSchemaXML.class, getNamedConfig(cfgName));
        }
    }

    public static void registerObjectMarshaller(Class<?> clazz, Closure<?> callable) throws ConverterException {
        registerObjectMarshaller(new ClosureObjectMarshaller<CRSchemaXML>(clazz, callable));
    }

    public static void registerObjectMarshaller(Class<?> clazz, int priority, Closure<?> callable) throws ConverterException {
        registerObjectMarshaller(new ClosureObjectMarshaller<CRSchemaXML>(clazz, callable), priority);
    }

    public static void registerObjectMarshaller(ObjectMarshaller<CRSchemaXML> om) throws ConverterException {
        ConverterConfiguration<CRSchemaXML> cfg = ConvertersConfigurationHolder.getConverterConfiguration(CRSchemaXML.class);
        if (cfg == null) {
            throw new ConverterException("Default Configuration not found for class " + CRSchemaXML.class.getName());
        }
        if (!(cfg instanceof DefaultConverterConfiguration<?>)) {
            cfg = new DefaultConverterConfiguration<CRSchemaXML>(cfg);
            ConvertersConfigurationHolder.setDefaultConfiguration(CRSchemaXML.class, cfg);
        }
        ((DefaultConverterConfiguration<CRSchemaXML>) cfg).registerObjectMarshaller(om);
    }

    public static void registerObjectMarshaller(ObjectMarshaller<CRSchemaXML> om, int priority) throws ConverterException {
        ConverterConfiguration<CRSchemaXML> cfg = ConvertersConfigurationHolder.getConverterConfiguration(CRSchemaXML.class);
        if (cfg == null) {
            throw new ConverterException("Default Configuration not found for class " + CRSchemaXML.class.getName());
        }
        ...
        ((DefaultConverterConfiguration<CRSchemaXML>) cfg).registerObjectMarshaller(om, priority);
    }

    public static void createNamedConfig(String name, Closure<?> callable) throws ConverterException {
        DefaultConverterConfiguration<CRSchemaXML> cfg = new DefaultConverterConfiguration<CRSchemaXML>(ConvertersConfigurationHolder.getConverterConfiguration(CRSchemaXML.class));
        try {
            callable.call(cfg);
            ConvertersConfigurationHolder.setNamedConverterConfiguration(CRSchemaXML.class, name, cfg);
        }
        catch (Exception e) {
            throw ConverterUtil.resolveConverterException(e);
        }
    ...
    public class Builder extends BuilderSupport {
        ...
        private CRSchemaXML xml;

        public Builder(CRSchemaXML xml) {
            this.xml = xml;
        }
