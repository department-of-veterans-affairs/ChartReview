...
Since the code coverage feature uses Ext JS charts, you also need to include this script file after the Ext JS framework.
    ...
    <script src="//cdn.sencha.com/ext/gpl/5.1.0/build/packages/ext-charts/build/ext-charts-debug.js" type="text/javascript"></script>

Please refer to the "/examples/browse-all-desktop.html" file from the Siesta package for a sample setup.
