StartTest(function(t) {
    ...
    var txt2 = new Ext.form.TextField({ height : 200, width : 200, renderTo : Ext.getBody() });

    t.it('normalizeComponent #1', function(t) {
        t.warn = function() {};

        t.isCalledOnce('warn', t)
        t.notOk(t.normalizeComponent('foo'), 'Found no match');
    })

    t.it('normalizeComponent #2', function(t) {
        t.warn = function() {};

        t.isCalledOnce('warn', t)
        
        t.is(t.normalizeComponent('textfield', false, { ignoreNonVisible : true }), t.cq1('textfield{isVisible()}'), 'Should warn and return first match when found > 1 matching components');
    })
