...
StartTest(function(t) {
    ...
    t.chain(
        ...
        { moveCursorTo : "#annotationlist => table.x-grid-item:nth-child(1) .x-grid-cell:nth-child(3)", offset : [54, 27] },

        { click : "#annotationlist => table.x-grid-item:nth-child(1) .x-grid-cell:nth-child(3)", offset : [54, 27] },

        { click : "#submitNextButton-btnInnerEl", offset : [46, 9] },

        { waitFor : "PageLoad", args : [], trigger : { click : "[itemId=ok] => .x-btn-button", offset : [28, 9] } }    );
})
