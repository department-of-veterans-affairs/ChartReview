    ...
    t.iit('DataView 1', function (t) {
        ...
        t.chain(
            ...
            function () {
                ...
                t.is(store.getAt(0).getTarget().target, '#pnl dataview => div.thumb-wrap:nth-child(1) span')
                t.is(store.getAt(1).getTarget().target, '#pnl dataview => div.thumb-wrap:nth-child(2) span')
                t.is(store.getAt(2).getTarget().target, '#pnl dataview => div.thumb-wrap:nth-child(3) span')
            }
        )
    })
