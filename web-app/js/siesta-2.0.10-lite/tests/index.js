...
Harness.start(
...

    {
        ...
        autoCheckGlobals    : false,
        preload             : [
            '../../extjs-5.0.1/packages/ext-theme-classic/build/resources/ext-theme-classic-all-debug.css',
            '../../extjs-5.0.1/build/ext-all-debug.js',
            '../siesta-all.js',
            'lib/Siesta/Test/AssertionsTranslator.js'
        ],
        items               : [
            ...
            {
                preload     : [
                    '../../extjs-5.0.0/build/ext-all-debug.js'
                ],
...
//            'extjs-component/013_HTMLEditor.t.js?Ext3',
    ...
    $.browser.msie ? null : {
        ...
        alsoPreload : [
            ...
            '../../extjs-4.2.2/examples/ux/ajax/SimXhr.js',
            '../../extjs-4.2.2/examples/ux/ajax/Simlet.js',
            '../../extjs-4.2.2/examples/ux/ajax/DataSimlet.js',
            '../../extjs-4.2.2/examples/ux/ajax/JsonSimlet.js',
            '../../extjs-4.2.2/examples/ux/ajax/SimManager.js'
        ],

        items : [
            {
                group       : 'Target extractor',
                items       : [
            ...
            'recorder/011_extjs_in_frame.t.js',
