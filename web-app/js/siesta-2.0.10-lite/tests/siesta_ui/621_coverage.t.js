StartTest(function (t) {
    ...
    t.it('Should show coverage info', function (t) {
        t.chain(
            ...
            { dblclick : "testgrid => .x-grid-row:nth-child(1) > .x-grid-cell:nth-child(1) .x-tree-node-text", offset : [99, 9] },

            { waitFor : 'harnessIdle' },

            { click : "toolbar button[iconCls=icon-book] => .icon-book", offset : [7, 10] },
    ...
    t.it('Should show chart or source when clicking rows', function (t) {
        t.chain(
            { click : "coveragereport treepanel => .x-grid-row:nth-child(1) > .x-grid-cell:nth-child(1)" },
            ...
            { click : "coveragereport treepanel => .x-grid-row:nth-child(2) > .x-grid-cell:nth-child(1) .x-tree-node-text" },
            ...
            { click : "coveragereport treepanel => .x-grid-row:nth-child(3) > .x-grid-cell:nth-child(1) .x-tree-node-text" },
