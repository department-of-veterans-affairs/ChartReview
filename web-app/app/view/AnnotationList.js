...
//    requires: ['Ext.data.*','Ext.grid.*','Ext.grid.property.Grid', 'CR.app.store.AnnotationListStore'],
    ...
    columns: [
          	{ header: 'Span', id: 'theSpan', dataIndex: 'span', minWidth:80, variableRowHeight: true, sortable: true, hideable: true, draggable: true, groupable: true, showInGroups: true, filter: {type: 'string'}, renderer:function(value){if(this.userWrapChoice){return Ext.String.format('<div class="cellTextWrap">{0}</div>', value)}else{return Ext.String.format('<div class="cellTextNowrap">{0}</div>', value)}}},
            { header: 'ClinicalElement Id', id: 'clinicalElementId',  dataIndex: 'clinicalElementId', minWidth:80, variableRowHeight: true, sortable: true, hideable: true, draggable: true, groupable: true, filter: {type: 'string'}, renderer:function(value){if(this.userWrapChoice){return Ext.String.format('<div class="cellTextWrap">{0}</div>', value)}else{return Ext.String.format('<div class="cellTextNowrap">{0}</div>', value)}} },
